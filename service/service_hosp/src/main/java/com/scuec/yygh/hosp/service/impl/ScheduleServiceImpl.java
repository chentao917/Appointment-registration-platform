...
import com.scuec.yygh.hosp.repository.ScheduleRepository;
...
import com.scuec.yygh.model.hosp.BookingRule;
...
import com.scuec.yygh.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
        ...
        //把得到的list集合遍历,设置其他的值:医院名称,科室名称,日期对应的兴起
    ...
    public Map<String, Object> getBookingScheduleRule(int page, int limit, String hoscode, String depcode) {
        ...
        //合并数据 map集合,key是日期,value是预约规则和剩余数量
        ...
        for (int i = 0, len = dateList.size(); i < len; i++) {
            Date date = dateList.get(i);//得到每个日期
...
//停号时间
    ...
    private IPage<Date> getListDate(int page, int limit, BookingRule bookingRule) {
        ...
        //因为预约周期是不同的,每页显示日期最多是7天数据,超过7天分页
