package com.scuec.yygh.user.api;
...
import com.scuec.yygh.user.utils.ConstantWxPropertiesUtils;
import com.scuec.yygh.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public String callback(String code, String state) {
        ...
        //第二步,拿着code和微信id 和 秘钥,请求微信固定地址,得到两个值
    ...
    public Result genQrConnect() {
        try {
            ...
            String wxOpenRedirectUri = URLEncoder.encode(ConstantWxPropertiesUtils.WX_OPEN_REDIRECT_URL, "utf-8");
