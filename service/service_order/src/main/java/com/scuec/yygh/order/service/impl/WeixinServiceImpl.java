...
import com.scuec.yygh.order.service.WeixinService;
import com.scuec.yygh.order.utils.ConstantPropertiesUtils;
import com.scuec.yygh.order.utils.HttpClient;
...
public class WeixinServiceImpl implements WeixinService {
    ...
    public Map createNative(Long orderId) {
        ...
        try {
            ...
            paramMap.put("total_fee", "1");//为了测试统一写成这个值
